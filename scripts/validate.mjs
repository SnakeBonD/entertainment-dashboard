...
assert(indexHtml.includes("v2.1.1"), "index.html : version v2.1.1 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.1.1, filtre Epic et cache PWA conformes.");
