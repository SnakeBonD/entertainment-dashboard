...
assert(indexHtml.includes("v2.9"), "index.html : version v2.9 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.9, choix express classable et cache PWA conformes.");
