...
assert(indexHtml.includes("v3.5"), "index.html : version v3.5 absente");
...
console.log("Validation réussie : 40 plateformes, version v3.5, actions annulables et cache PWA conformes.");
