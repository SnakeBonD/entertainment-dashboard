...
assert(indexHtml.includes("v3.3"), "index.html : version v3.3 absente");
...
console.log("Validation réussie : 40 plateformes, version v3.3, indicateur de progression et cache PWA conformes.");
