...
assert(indexHtml.includes("v2.6"), "index.html : version v2.6 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.6, filtre Aujourd’hui mémorisé et cache PWA conformes.");
