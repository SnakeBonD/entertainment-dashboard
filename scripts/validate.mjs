...
assert(indexHtml.includes("v3.4"), "index.html : version v3.4 absente");
...
console.log("Validation réussie : 40 plateformes, version v3.4, progression groupée et cache PWA conformes.");
