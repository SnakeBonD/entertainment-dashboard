...
assert(indexHtml.includes("v2.8"), "index.html : version v2.8 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.8, choix express renouvelable et cache PWA conformes.");
