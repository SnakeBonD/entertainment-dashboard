...
assert(indexHtml.includes("v2.7"), "index.html : version v2.7 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.7, choix express expliqué et cache PWA conformes.");
