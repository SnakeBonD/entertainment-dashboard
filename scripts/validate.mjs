...
assert(indexHtml.includes("v3.0"), "index.html : version v3.0 absente");
...
console.log("Validation réussie : 40 plateformes, version v3.0, programme quotidien et cache PWA conformes.");
