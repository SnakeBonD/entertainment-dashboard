...
assert(indexHtml.includes("v2.5"), "index.html : version v2.5 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.5, choix express Aujourd’hui et cache PWA conformes.");
