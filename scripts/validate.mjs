...
assert(indexHtml.includes("v2.4"), "index.html : version v2.4 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.4, actions Aujourd’hui annulables et cache PWA conformes.");
