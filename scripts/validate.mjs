...
assert(indexHtml.includes("v2.2"), "index.html : version v2.2 absente");
...
console.log("Validation réussie : 40 plateformes, version v2.2, sélection quotidienne et cache PWA conformes.");
