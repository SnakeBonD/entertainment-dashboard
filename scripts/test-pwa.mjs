...
assert(indexHtml.includes("v1.8"), "La version v1.8 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v1.8.0`'), "La version du cache v1.8 est absente");
