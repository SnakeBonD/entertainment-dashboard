...
assert(indexHtml.includes("v1.4"), "La version v1.4 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v1.4.0`'), "La version du cache v1.4 est absente");
