...
assert(indexHtml.includes("v1.3"), "La version v1.3 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v1.3.0`'), "La version du cache v1.3 est absente");
