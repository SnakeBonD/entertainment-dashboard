...
assert(indexHtml.includes("v1.9"), "La version v1.9 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v1.9.0`'), "La version du cache v1.9 est absente");
