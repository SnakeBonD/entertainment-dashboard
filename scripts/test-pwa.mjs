...
assert(indexHtml.includes("v2.3"), "La version v2.3 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v2.3.0`'), "La version du cache v2.3 est absente");
