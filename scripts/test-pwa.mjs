...
assert(indexHtml.includes("v2.0"), "La version v2.0 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v2.0.0`'), "La version du cache v2.0 est absente");
