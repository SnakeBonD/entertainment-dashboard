...
assert(indexHtml.includes("v1.5"), "La version v1.5 est absente du HTML");
...
assert(serviceWorker.includes('CACHE_NAME = `${CACHE_PREFIX}v1.5.0`'), "La version du cache v1.5 est absente");
