...
assert.deepEqual(Array.from(program.remove("b", storage, now), (entry) => entry.id), ["a", "c"]);
...
console.log("Programme du jour v3.0 validé : limite, doublons, retrait et réinitialisation quotidienne conformes.");
